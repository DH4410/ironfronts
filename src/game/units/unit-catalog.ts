...
export const UNIT_TYPES: readonly UnitType[] = [
  {
    ...
    engagementRange: 0,
    cost: { funds: 200, manpower: 40, food: 100 },
    buildTimeHours: 6 / (4 * PROTOTYPE_HOURS_PER_HOUR),
  ...
  },
  {
    ...
    buildTimeHours: 7 / (4 * PROTOTYPE_HOURS_PER_HOUR),
    requiredBuilding: 'barracks',
    stackPriority: 8,
  },
  {
    ...
    buildTimeHours: 8 / (4 * PROTOTYPE_HOURS_PER_HOUR),
  ...
  },
  {
    ...
    extractionRate: 0 * PROTOTYPE_HOURS_PER_HOUR,
    engagementRange: 0,
    cost: { funds: 1000, manpower: 15, metal: 70, oil: 35, food: 300 },
    buildTimeHours: 12 / (4 * PROTOTYPE_HOURS_PER_HOUR),
    requiredBuilding: 'tankPlant',
    stackPriority: 40,
  },
  {
    ...
    extractionRate: 0 * PROTOTYPE_HOURS_PER_HOUR,
    engagementRange: 0,
    cost: { funds: 1800, manpower: 25, metal: 120, oil: 60, food: 450 },
    buildTimeHours: 20 / (4 * PROTOTYPE_HOURS_PER_HOUR),
    requiredBuilding: 'tankPlant',
    stackPriority: 70,
  },
  {
    ...
    buildTimeHours: 14 / (4 * PROTOTYPE_HOURS_PER_HOUR),
